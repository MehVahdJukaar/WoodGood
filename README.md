...
For more extension points check out all the entry sets builder methods or for more advanced stuff use the overrides in the module or subclass entryset if needed.
