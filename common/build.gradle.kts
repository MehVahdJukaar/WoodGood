...
//    modCompileOnly("curse.maven:configured-457570:7122913") // v2.6.2 - NOT ADDED YET
    modCompileOnly("curse.maven:framework-549225:7530361") // v0.9.4 | +Refurbished-Furniture, Mighty-Mail, Backpacked
    modCompileOnly("curse.maven:resourceful-lib-570073:5973188") // v2.1.29
    modCompileOnly("curse.maven:architectury-api-419699:5786327") // v9.2.14
...
//    modCompileOnly("org.violetmoon.zeta:Zeta:1.1-36-SNAPSHOT") // Quark - @ DNU - https://maven.blamejared.com/org/violetmoon/zeta/Zeta/
    modCompileOnly("curse.maven:zeta-968868:7980010") // v1.1-39 | TEMP BACKUP MAVEN
...
//    modCompileOnly("curse.maven:macaws-stairs-1119394:5802484") // Not needed
    ...
    //+ GENERAL
    modCompileOnly("curse.maven:another-furniture-610492:7355747") //!! 1.20.1
...
//    modCompileOnly("curse.maven:farmersdelight-398521:5962800")
    ...
    modCompileOnly("curse.maven:more-crafting-tables-lieonlion-913586:5330971") //!! 1.20.1
...
//    modCompileOnly("curse.maven:rechiseled-558998:7687483") // Fusion, supermartijn642s-[ Config-Lib, Core-Lib ] //!! Not created yet - do not import it because fabric-loom is v1.14+
    ...
    modCompileOnly("curse.maven:valhelsia-furniture-694349:6341023") //!! 1.20.1
    ...
    modCompileOnly("curse.maven:quark-243121:8146177") // v4.1.474 | TEMP BACKUP MAVEN
