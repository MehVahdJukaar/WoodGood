package net.mehvahdjukaar.every_compat.modules.fabric;
...
public class MacawStairsModule extends SimpleModule {
    ...
    public MacawStairsModule(String modId) {
        super(modId, "mws");
        var tab = StairsItemGroup.STAIRSITEMGROUP;
    ...
    public BlockBehaviour.Properties copyProperties() {
        return BlockBehaviour.Properties.of(Material.WOOD).color(MaterialColor.WOOD)
                .strength(2.0F, 2.3F)
