...
//                .addTag(Tags.Blocks.GLASS_PANES, Registries.ITEM)
    ...
    private static class BDBlockItem extends BlockItem {
        ...
        @Override
        public void appendHoverText(@NotNull ItemStack pStack, Level pLevel, List<Component> pTooltip, TooltipFlag pFlag) {
    ...
    public void planksTags(WoodType wood, DynamicDataPack DDPack, EntrySet<?, ?, ?>... entries) {
        /*
        planksTags is used as ingreident for crafting Glass_1
         */
    ...
    // glass_1 has tag for ingredients, so defaultRecipe() won't work
