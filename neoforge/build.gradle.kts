...
//!! TOOLS ========================================================================================================== \\
    ...
    modRuntimeOnly("curse.maven:jei-238222:7057366") // v19.25.0.322
    modRuntimeOnly("curse.maven:jade-324717:6667790") // v15.10.1
//    modRuntimeOnly("curse.maven:worldedit-225608:5830452")

    //+ REQUIRED
    modImplementation("curse.maven:configured-457570:7122915") // v2.6.2
...
//    modRuntimeOnly("maven.modrinth:midnightlib:YeePowOJ") // v1.6.3 | Building-But-Better
    modRuntimeOnly("curse.maven:patchouli-306770:6842247") // v92 | TFC, Timber-Frames
...
//    modRuntimeOnly("com.teamresourceful.resourcefullib:resourcefullib-neoforge-1.21:$resourcefullib_version") // Chipped, Handcrafted, Cozy, Friends&Foes
    ...
    modCompileOnly("curse.maven:titanium-287342:6875285") // v4.0.40 | Functional-Storage
    modCompileOnly("curse.maven:blueprint-382216:7148094") // v8.0.8 | The-Outer-End, Woodworks, Boatload, Upgrade-Aquatic, Curiosities!, Autumnity
...
//    modRuntimeOnly("copper-age-neoforge:copperagebackport-neoforge-1.21.1-0.1.4")
    ...
    // MACAW's
    modCompileOnly("curse.maven:macaws-bridges-351725:5465228")
    ...
    modCompileOnly("curse.maven:macaws-lights-and-lamps-502372:5473578")
    modCompileOnly("curse.maven:macaws-paths-and-pavings-629153:7029451") // v1.1.1
    modCompileOnly("curse.maven:macaws-roofs-352039:5554896")
    modCompileOnly("curse.maven:macaws-trapdoors-400933:5977602")
    modCompileOnly("curse.maven:macaws-windows-363569:5592081")
    modCompileOnly("curse.maven:macaws-furniture-359540:7255584")
    modCompileOnly("curse.maven:macaws-stairs-1119394:5802422")

    //+ GENERAL
    modCompileOnly("curse.maven:absent-by-design-305840:4616702") //!! 1.20.1
    modCompileOnly("curse.maven:beautify-decorate-633252:5947973")
    modCompileOnly("curse.maven:bibliocraft-legacy-1122260:6533545")
    modCompileOnly("curse.maven:boatload-337396:6449892")
    modCompileOnly("curse.maven:buildersaddition-389697:5544431")
    modCompileOnly("curse.maven:corail-pillar-266228:5669131") //TODO: Move the module to COMMON
    modCompileOnly("curse.maven:curiosities-syndicate-1489190:7777694") // Blueprint
    modCompileOnly("curse.maven:decoration-delight-687475:5563942") //!! 1.20.1
    modCompileOnly("curse.maven:domum-ornamentum-527361:4174257") //!! 1.20.1
    modCompileOnly("curse.maven:dramatic-doors-380617:6479044")
    modCompileOnly("curse.maven:functional-storage-556861:6930104")
    modCompileOnly("curse.maven:infinity-buttons-661902:4716983") //!! 1.20.1
    modCompileOnly("curse.maven:just-a-raft-mod-274350:5777240")
    modCompileOnly("curse.maven:lightmans-currency-472521:6524192")
    modCompileOnly("curse.maven:mighty-mail-902986:4750272") //!! 1.20.1
    ...
    modCompileOnly("curse.maven:productivebees-377897:5304827") //v12.5.1 | WIP //!! 1.20.1
    modCompileOnly("curse.maven:redeco-897377:5603009") //!! 1.20.1
    modCompileOnly("curse.maven:table-top-craft-467136:5318681") //!! 1.20.1
    modCompileOnly("curse.maven:the-graveyard-forge-531188:4025847") //!! 1.20.1
    ...
    modCompileOnly("curse.maven:tropicraft-254794:5658664")
    modCompileOnly("curse.maven:unusual-furniture-1278034:7147429")
    ...
    modCompileOnly("curse.maven:woodster-869951:6425772")
    modCompileOnly("curse.maven:woodworks-543610:7118286") // Blueprint
    modCompileOnly("curse.maven:workshop-for-handsome-adventurer-875843:7738950")
    modCompileOnly("curse.maven:xercamod-341575:4667995") //!! 1.20.1

    modCompileOnly("curse.maven:regions-unexplored-659110:7434056")

    // OTHER MAVENS
    modCompileOnly("maven.modrinth:building-but-better:zGMhmLYb") // v1.1.1 | MidnightLib //!! 1.20.1
...
//    modRuntimeOnly("curse.maven:blue-skies-312918:5010316") // structure-gel-api //!! 1.20.1
    modRuntimeOnly("curse.maven:biomes-o-plenty-220318:6501142") // Terrablender, GlitchCore
