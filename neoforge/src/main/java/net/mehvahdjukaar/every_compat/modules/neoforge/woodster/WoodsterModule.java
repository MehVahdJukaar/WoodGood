...
public class WoodsterModule extends SimpleModule {
    ...
    public WoodsterModule(String modId) {
        ...
        chiseled_books = SimpleEntrySet.builder(WoodType.class, "chiseled_bookshelf",
                ...
                .addTextureM(modRes("block/everycomp_chiseled_bookshelf_6"),modRes("block/everycomp_chiseled_bookshelf_overlay"))
                .addTexture(modRes("block/everycomp_chiseled_bookshelf_side"))
                .addTexture(modRes("block/everycomp_chiseled_bookshelf_top"))
                .addTexture(modRes("block/everycomp_chiseled_bookshelf_0"))
