...
public class LegacyCM extends CompatModule {
    ...
    public void addDynamicClientResources(ClientDynamicResourcesHandler handler, ResourceManager manager) {
        ...
        try (TextureImage window = TextureImage.open(manager, WoodGood.res("block/oak_window"));
             TextureImage window_m = TextureImage.open(manager, WoodGood.res("block/oak_window_m"));
             TextureImage connected = TextureImage.open(manager, WoodGood.res("block/oak_window_connected"));
             TextureImage connected_m = TextureImage.open(manager, WoodGood.res("block/oak_window_connected_m"))) {
    ...
    public void addTranslations(ClientDynamicResourcesHandler clientDynamicResourcesHandler, AfterLanguageLoadEvent lang) {
        WINDOW_PANES.forEach((w, v) -> LangBuilder.addDynamicEntry(lang, "block.everycomp.window_pane", w, v));
        WINDOWS.forEach((w, v) -> LangBuilder.addDynamicEntry(lang, "block.everycomp.window", w, v));
    }
}
