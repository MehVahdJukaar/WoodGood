...
public class MacawBridgesModule extends SimpleModule {
    ...
    public MacawBridgesModule(String modId) {
        ...
        BRIDGE_PIERS = SimpleEntrySet.builder("bridge_pier",
        ...
        ROPE_BRIDGES = SimpleEntrySet.builder("bridge", "rope",
        ...
        BRIDGE_MIDDLES = SimpleEntrySet.builder("log_bridge_middle",
        ...
        RAIL_BRIDGES = SimpleEntrySet.builder("rail_bridge",
        ...
        BRIDGE_STAIRS = SimpleEntrySet.builder("log_bridge_stair",
        ...
        ROPE_STAIRS = SimpleEntrySet.builder("rope_bridge_stair",
