...
public class MacawTrapdoorsModule extends SimpleModule {
    ...
    public MacawTrapdoorsModule(String modId) {
        super(modId, "mct");
        var tab = MacawsTrapdoors.TrapDoorItemGroup;

        BARK_TRAPDOORS = SimpleEntrySet.builder(WoodType.class,"bark_trapdoor",
                        BlockInit.OAK_BARK_TRAPDOOR, () -> WoodType.OAK_WOOD_TYPE,
                        w -> new TrapDoorBlock(WoodGood.copySafe(w.planks).strength(1.5F, 2.5F).noOcclusion()))
        ...
        BARN_TRAPDOORS = SimpleEntrySet.builder(WoodType.class,"barn_trapdoor",
                        ...
                        w -> new TrapDoorBlock(WoodGood.copySafe(w.planks).strength(1.5F, 2.5F)))
                .addTag(BlockTags.MINEABLE_WITH_AXE, Registry.BLOCK_REGISTRY)
                .addTag(BlockTags.TRAPDOORS, Registry.BLOCK_REGISTRY)
                .addTag(BlockTags.WOODEN_TRAPDOORS, Registry.BLOCK_REGISTRY)
                .addTag(ItemTags.TRAPDOORS, Registry.ITEM_REGISTRY)
        ...
        MESH_TRAPDOORS = SimpleEntrySet.builder(WoodType.class, "bamboo_trapdoor",
                        BlockInit.OAK_BAMBOO_TRAPDOOR, () -> WoodType.OAK_WOOD_TYPE,
                        w -> new TrapDoorBlock(WoodGood.copySafe(w.planks).noOcclusion()))
                .addTag(BlockTags.MINEABLE_WITH_AXE, Registry.BLOCK_REGISTRY)
                .addTag(BlockTags.TRAPDOORS, Registry.BLOCK_REGISTRY)
                .addTag(BlockTags.WOODEN_TRAPDOORS, Registry.BLOCK_REGISTRY)
                .addTag(ItemTags.TRAPDOORS, Registry.ITEM_REGISTRY)
        ...
        RANCH_TRAPDOORS = SimpleEntrySet.builder(WoodType.class, "ranch_trapdoor",
                        BlockInit.OAK_RANCH_TRAPDOOR, () -> WoodType.OAK_WOOD_TYPE,
                        w -> new TrapDoorBlock(WoodGood.copySafe(w.log).noOcclusion()))
                .addTag(BlockTags.MINEABLE_WITH_AXE, Registry.BLOCK_REGISTRY)
                .addTag(BlockTags.TRAPDOORS, Registry.BLOCK_REGISTRY)
                .addTag(BlockTags.WOODEN_TRAPDOORS, Registry.BLOCK_REGISTRY)
                .addTag(ItemTags.TRAPDOORS, Registry.ITEM_REGISTRY)
        ...
        SWAMP_TRAPDOORS = SimpleEntrySet.builder(WoodType.class, "swamp_trapdoor",
                        BlockInit.OAK_SWAMP_TRAPDOOR, () -> WoodType.OAK_WOOD_TYPE,
                        w -> new TrapDoorBlock(WoodGood.copySafe(w.planks).noOcclusion()))
                .addTag(BlockTags.MINEABLE_WITH_AXE, Registry.BLOCK_REGISTRY)
                .addTag(BlockTags.TRAPDOORS, Registry.BLOCK_REGISTRY)
                .addTag(BlockTags.WOODEN_TRAPDOORS, Registry.BLOCK_REGISTRY)
        ...
        WAFFLE_TRAPDOORS = SimpleEntrySet.builder(WoodType.class, "blossom_trapdoor",
                        BlockInit.OAK_BLOSSOM_TRAPDOOR, () -> WoodType.OAK_WOOD_TYPE,
                        w -> new TrapDoorBlock(WoodGood.copySafe(w.planks).noOcclusion()))
                .addTag(BlockTags.MINEABLE_WITH_AXE, Registry.BLOCK_REGISTRY)
                .addTag(BlockTags.WOODEN_TRAPDOORS, Registry.BLOCK_REGISTRY)
                .addTag(ItemTags.WOODEN_TRAPDOORS, Registry.ITEM_REGISTRY)
